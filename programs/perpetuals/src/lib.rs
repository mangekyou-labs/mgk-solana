...
declare_id!("E4digHpb1shbPFxdQTd6D6tnDnNYznrnNPoduHDtEn9H");
...
pub mod perpetuals {
    ...
    pub fn batch_settle_dark_pool_trades(
        ...
        instructions::batch_settle_dark_pool_trades(ctx, &params)
    }
}
