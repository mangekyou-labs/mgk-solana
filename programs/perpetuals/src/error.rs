...
pub enum PerpetualsError {
    ...
    // Darkpool specific errors
    #[msg("Invalid darkpool signature")]
    InvalidSignature,
    #[msg("Trade data is too old")]
    TradeDataTooOld,
    #[msg("Invalid trade sides - must be opposite")]
    InvalidTradeSides,
    #[msg("Price slippage too high for darkpool trade")]
